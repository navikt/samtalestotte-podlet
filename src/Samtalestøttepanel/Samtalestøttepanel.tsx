    ...
    if (visningsmodus === Visningsmodus.SNAKKEBOBLE) {
        return (<>
            <Snakkeboble src={female} alt="Female rådgiver">
                {<Normaltekst>Samtaler rundt sykefravær kan være vanskelige. Vi har laget et verktøy for arbeidsgivere for å gjøre det lettere å forberede seg til samtaler med medarbeidere!
                </Normaltekst>}
            </Snakkeboble>
            {fellesLenke}</>);    } else {
        return (
